...
class TestStructures:
    ...
    def test_arrays_replicated_3d(self):
        ...
        s = idlsave.read(path.join(DATA_PATH, 'struct_arrays_replicated_3d.sav'), verbose=False)
    ...
    def test_inheritance(self):
        s = idlsave.read(path.join(DATA_PATH, 'struct_inherit.sav'), verbose=False)
...
class TestPointerStructures:
    ...
    def test_pointers_replicated(self):
        s = idlsave.read(path.join(DATA_PATH, 'struct_pointers_replicated.sav'), verbose=False)
    ...
    def test_arrays_replicated_3d(self):
        ...
        s = idlsave.read(path.join(DATA_PATH, 'struct_pointer_arrays_replicated_3d.sav'), verbose=False)
